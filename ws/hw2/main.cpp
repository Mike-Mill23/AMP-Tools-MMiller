...
int main(int argc, char** argv) {
    ...
    */
    ...
    //     // To get collisions, call check with third parameter
    //     // std::vector<Eigen::Vector2d> collisions;
    //     // success = HW2::check(path, problem, collisions);
    //     // for (int i = 0; i < collisions.size(); i++) {
    //     //     LOG("Collision " << i << ": " << collisions[i]);
    //     // }
    ...
    //     LOG("Found valid solution to workspace 2: " << (success2 ? "Yes!" : "No :("));
    ...
    HW2::grade(algo, "michael.miller-5@colorado.edu", argc, argv);
